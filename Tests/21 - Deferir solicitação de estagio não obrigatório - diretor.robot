*** Settings ***
Documentation     Realizar o deferimento de uma solicitação de estágio não obrigatório pelo diretor
...
Test Case 01: Acessa Minha conta do usuário
    Verifico o status da requisição de estágio não obrigatório para "diretor"
    Acesso a home page
