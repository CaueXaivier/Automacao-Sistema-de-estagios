*** Settings ***
Documentation     Realizar o deferimento de uma solicitação de cancelamento pelo coordenador de curso
...
Test Case 03: Realizo o deferimento da solicitação de cancelamento
    ...
    Valido as informações e como "coordenador" defiro a solicitação de cancelamento
...
Test Case 04: Verifico se a solicitação de cancelamento está em análise
    ...
    Valido se as opções da Home são corretamente apresentadas
    Clico em ir para solicitações de cancelamento
    Valido se a solicitação deferida pelo "coordenador" consta como em análise
