*** Settings ***
Documentation     Realizar o deferimento de uma solicitação de renovação pelo coordenador de curso
...
Test Case 01: Acessa Minha conta do usuário
    Verifico o status da requisição de renovação para "coordenador"
    Acesso a home page
...
Test Case 03: Realizo o deferimento da solicitação de renovação 
    ...
    Valido as informações e como "coordenador" defiro a solicitação de renovação
